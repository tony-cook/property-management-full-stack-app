...
export default function Search() {
  return (
    ...
    >
      <Autocomplete sx={{ flexGrow: 1, '& .MuiButtonBase-root': { backgroundColor: 'red.main', color: 'white', mr: 0.5 }, '& .MuiSvgIcon-root': { color: 'background.main' } }} multiple id="tags-outlined" options={tags} getOptionLabel={option => option} defaultValue={[]} filterSelectedOptions renderInput={params => <TextField {...params} label="Tags" placeholder="Add tags: e.g. 'Available Now'" />} />
